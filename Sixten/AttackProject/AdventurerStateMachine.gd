...
var sprite:Sprite
var explosionSpawner:ExplosionSpawner
...
func checkAttackOptions():
	var dir:int = -1 if sprite.flip_h else 1
	if Input.is_action_pressed("Attack1"):
		explosionSpawner.Attack1(dir)
	if Input.is_action_pressed("Attack2"):
		explosionSpawner.Attack2(dir)
	if Input.is_action_pressed("Attack3"):
		explosionSpawner.Attack3(dir)
	if Input.is_action_pressed("Attack4"):
		explosionSpawner.Attack4(dir)
	if Input.is_action_pressed("Attack5"):
		explosionSpawner.Attack5(dir)
	if Input.is_action_pressed("Attack6"):
		explosionSpawner.Attack6(dir)
